...
- See [Robert Ghrist's YT video](https://www.youtube.com/watch?v=Gy2VsurG_yo&list=PL8erL0pXF3JaJdUcmc_PeGV-vG5z87BkD)
...
- Key point: distribution of $\varphi_{\xi,t}$ is affected by the polymer trajectories "planted" in it, with the size of the effect being determined by $\epsilon$.
...
- _Planting_: generate samples by sampling $x_t$ from prior and using observation model $p(\varphi_{1:T}|x_{1:T})$

![](assets/2_good_image.svg)

- See review by [Zdeborová and Krzakala (2016)](https://www.tandfonline.com/doi/full/10.1080/00018732.2016.1211393)
...
<figure align="center">
<img src="assets/19_1d_phase_diagram.svg" width="80%"/>
</figure>

## Connection to quantum problem
...
<figure align="center">
<img src="assets/derrida-spohn-tree.png" width="40%"/>
</figure>
...
![Source: [Derrida and Spohn (1988)](https://link.springer.com/article/10.1007/BF01014886)](assets/derrida-spohn-branching.png)
...
<figure align="center">
<img src="assets/23_faster.svg" width="70%"/>
</figure>
...
<figure align="center">
<img src="assets/18_tree_phase_diagram.svg" width="80%"/>
</figure>
